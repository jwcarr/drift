...
print(attach(fixation_XY, line_Y))

print('Output from the chain algorithm')
print(chain(fixation_XY, line_Y))

print('Output from the cluster algorithm')
print(cluster(fixation_XY, line_Y))

print('Output from the regress algorithm')
print(regress(fixation_XY, line_Y))

print('Output from the segment algorithm')
print(segment(fixation_XY, line_Y))

print('Output from the warp algorithm')
print(warp(fixation_XY, character_XY))
