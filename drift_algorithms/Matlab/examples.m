...
disp(attach(fixation_XY, line_Y));

disp('Output from the chain algorithm');
disp(chain(fixation_XY, line_Y));

disp('Output from the cluster algorithm');
disp(cluster(fixation_XY, line_Y));

disp('Output from the regress algorithm');
disp(regress(fixation_XY, line_Y));

disp('Output from the segment algorithm');
disp(segment(fixation_XY, line_Y));

disp('Output from the warp algorithm');
disp(warp(fixation_XY, character_XY));
