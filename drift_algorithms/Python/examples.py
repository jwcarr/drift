...
# XY coordinates of the fixations
...
# Y coordinates of the lines of text
line_Y = np.array([155, 219, 283, 347], dtype=int)

# XY coordinates of the characters of text (only needed by warp)
...
print(drift_algorithms.attach(fixation_XY.copy(), line_Y))

print('Output from the chain algorithm')
print(drift_algorithms.chain(fixation_XY.copy(), line_Y))

print('Output from the cluster algorithm')
print(drift_algorithms.cluster(fixation_XY.copy(), line_Y))

print('Output from the regress algorithm')
print(drift_algorithms.regress(fixation_XY.copy(), line_Y))

print('Output from the segment algorithm')
print(drift_algorithms.segment(fixation_XY.copy(), line_Y))

print('Output from the warp algorithm')
print(drift_algorithms.warp(fixation_XY.copy(), character_XY))
