...
for trial_id, trial in datasets['sample'].items():
	...
	sample_image.set_caption(f'Participant {trial["participant_id"]}, passage {trial["passage_id"]} ({age})', font_face='Helvetica Neue', font_size=8)
...
booklet.save('../visuals/corrections.pdf', crop_margin=2)
